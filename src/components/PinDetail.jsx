    ...
    return ( 
        ...
        <div className="flex xl:flex-row flex-col m-auto bg-white" style={{maxWidth:'1500px',borderRadius:'32px'}}>
            ...
            <div className="w-full p-5 flex-1 xl:min-w-620">
                <div className="flex items- center justify-between">
                    ...
                    <a href={pinDetail.destination} target="_blank" rel="noreferrer" className="flex items-center bg-slate-100 p-3 rounded-full">
                        <BsFillArrowUpRightCircleFill/>&nbsp;{pinDetail.destination}
                    </a>
                </div>
                <div>
                ...
                <div className="max-h-370 overflow-y-auto">
                    {pinDetail?.comments?.map((comment,i)=>(
                        <div className="flex gap-2 mt-5 items-center bg-white rounded-lg" key={i}>
                            ...
                            alt="user-profile" 
                            className="w-10 h-10 rounded-full cur"
                            />
        ...
        {pins?.length > 0 ? (
            <>
                ...
                <MasonryLayout pins={pins} setRerender={setRerender}/>
            </>
        ):(
            ""
        )}
